...
class DoubleLightningTest {
    ...
    void setUpBeforeEach() {
        ...
        hud = mock(IHud.class);
        popUpItem = new DoubleLightning(player, world, hud, powerups, 1, 1);
    }

    /**
     * Verify that PopUpItem doubleLightning.class runs properly.
     */
    @Test
    void doubleLightningTest() {
        try {
