...
class SingleLightningTest {
    ...
    void setUpBeforeEach() {
        ...
        hud = mock(IHud.class);
        popUpItem = new SingleLightning(player, world, hud, powerups, 1, 1);
    }

    /**
     * Verify that PopUpItem singleLightning.class runs properly.
     */
    @Test
    void singleLightningTest() {
        try {
