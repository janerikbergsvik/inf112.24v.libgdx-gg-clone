...
/**
 * The Class CompletedScreen.
 */
public class CompletedScreen extends AbstractScreen implements Screen {	  
	...
	/**
	 * Instantiates a new completed screen.
	 *
	 * @param game the game
	 ...
	 */
	public CompletedScreen(MainGame game, Batch batch, ILevelManager levels, IHud hud, IAudio audio) {
	...
	protected void setupTable() {
        ...
        Label instruction1 = new Label(" CONGRATULATIONS ! ", skin, "big");
        Label instruction2 = new Label(" ", skin);
        Label instruction3 = new Label(" YOU HAVE COMPLETED ", skin, "big");
        Label instruction4 = new Label(" ", skin);
        Label instruction5 = new Label(" THE GAME ! ", skin, "big");
        Label instruction6 = new Label(" ", skin);
        Label instruction7 = new Label(String.format("CURRENT SCORE / HIGH SCORE"), skin, "big");
        Label instruction8 = new Label(" ", skin);
        Label instruction9 = new Label(String.format("%d / %d", hud.getScore(), this.game.getSettings().getHighScore()), skin, "big");
        Label instruction10 = new Label(" ", skin);
        ...
        table.add(instruction9).expandX().pad(1).row(); // Add instruction3 with padding
        table.add(instruction10).expandX().pad(1).row(); // Add instruction3 with padding
	...
	public void dispose() {
		...
		// Should even more of these be disposed? Likely.
        skin.dispose();
        atlas.dispose();
	}
}
